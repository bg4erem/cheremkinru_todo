...
def loginuser(request):
    if request.method == 'GET':
        ...
        if user is None:
            return render(request, 'todo/loginuser.html', {'form': AuthenticationForm, 'error':'Incorrect credentials'})
        else:
            login(request, user)
            return redirect('home')
...
def createtodo(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/createtodo.html', {'form': TodoForm, 'error':'ValueError. Bad data'})
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/viewtodo.html', {'form': TodoForm, 'error':'ValueError. Bad data'})
